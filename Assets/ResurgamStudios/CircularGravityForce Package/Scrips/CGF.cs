        ...
        private void CalculateAndEstimateForce()
        {
            if (_shape == Shape.Sphere || _shape == Shape.Box)
            {
                ...
                if (_shape == Shape.Sphere)
                {
                    ...
                    {
#if !(UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2)
                        colliderListCount = Physics.OverlapSphereNonAlloc(this.transform.position, Size, colliderList, _memoryProperties.ColliderLayerMask);
#else
                    ...
                    {
                        colliderList = Physics.OverlapSphere(this.transform.position, Size, _memoryProperties.ColliderLayerMask);
                ...
                if (_shape == Shape.Box)
                {
                    ...
                    if (_memoryProperties.NonAllocPhysics)
                    {
                        colliderListCount = Physics.OverlapBoxNonAlloc(this.transform.position, BoxSize, colliderList, this.transform.rotation, _memoryProperties.ColliderLayerMask);
                    }
                    else
                    {
                        colliderList = Physics.OverlapBox(this.transform.position, BoxSize, this.transform.rotation, _memoryProperties.ColliderLayerMask);
                        colliderListCount = colliderList.Length;
                    }
#else
            ...
            else
            {
                ...
                if (_shape == Shape.Raycast)
                {
                    ...
                    {
#if !(UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2)
                        raycastHitListCount = Physics.RaycastNonAlloc(cgfTran.position, cgfTran.rotation * Vector3.forward, raycastHitList, Size, _memoryProperties.ColliderLayerMask);
#else
                        Debug.LogWarning(WarningMessageNonAllocUnity_5_3);
#endif
                    }
                    ...
                    {
                        raycastHitList = Physics.RaycastAll(cgfTran.position, cgfTran.rotation * Vector3.forward, Size, _memoryProperties.ColliderLayerMask);
                ...
                else if (_shape == Shape.Capsule)
                {
                    ...
                    {
#if !(UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2)
                        raycastHitListCount = Physics.CapsuleCastNonAlloc(cgfTran.position, cgfTran.position + ((cgfTran.rotation * Vector3.back)), capsuleRadius, cgfTran.position - ((cgfTran.position + (cgfTran.rotation * (Vector3.back)))), raycastHitList, Size, _memoryProperties.ColliderLayerMask);
#else
                        Debug.LogWarning(WarningMessageNonAllocUnity_5_3);
#endif
                    }
                    ...
                    {
                        raycastHitList = Physics.CapsuleCastAll(cgfTran.position, cgfTran.position + ((cgfTran.rotation * Vector3.back)), capsuleRadius, cgfTran.position - ((cgfTran.position + (cgfTran.rotation * (Vector3.back)))), Size, _memoryProperties.ColliderLayerMask);
                        raycastHitListCount = raycastHitList.Length;
                    }
                }
