...
namespace CircularGravityForce
{
    public class CGF_Tool : EditorWindow
    {
        ...
        {
            Application.OpenURL("http://resurgamstudios.com/cgf-manual.html");
        }
        [MenuItem("Tools/Resurgam Studios/CGF/Support/Videos", false)]
        public static void SupportVideos()
        {
            Application.OpenURL("http://resurgamstudios.com/cgf-videos.html");
        }
        ...
        {
            Application.OpenURL("http://resurgamstudios.com/cgf-VersionHistory.html");
        }
